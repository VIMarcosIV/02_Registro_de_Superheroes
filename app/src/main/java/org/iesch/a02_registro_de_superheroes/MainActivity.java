...
public class MainActivity extends AppCompatActivity {
    ...
    private void abrirCamara() {
        // 7.- Vamos a pedirle a Android que si hay alguna APP que ejecute esa accion
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        // 9.- Si hacemos click en el "back" de la cámara recibiremos un RESULT_CANCEL y si hacemos la foto un RESULT_OK
